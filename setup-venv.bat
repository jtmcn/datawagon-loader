...
python -c "import sys; print('OK' if sys.version_info >= (3, 11) else 'FAIL'); print(f'{sys.version_info.major}.{sys.version_info.minor}.{sys.version_info.micro}')" > "%TEMP%\dw_pyver.txt" 2>&1
if errorlevel 1 (
